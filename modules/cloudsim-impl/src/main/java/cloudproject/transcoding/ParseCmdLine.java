...
public class ParseCmdLine {
	...
	@Option(name = "-estoutput", usage = "estimation output file url")
    private String estOutputdataFileURL = null;
    ...
    public String getEstOutputdataFileURL() {
		return estOutputdataFileURL;
	}

	public void setEstOutputdataFileURL(String estOutputdataFileURL) {
		this.estOutputdataFileURL = estOutputdataFileURL;
	}
