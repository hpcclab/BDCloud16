...
public class VideoSegment extends Cloudlet{
	...
	private long estimatedCloudletLength;
	...
	public VideoSegment(
		    ...
		    final long estimatedCloudletLength,
	   ...
	   this.estimatedCloudletLength = estimatedCloudletLength;
	...
	public long getEstimatedCloudletLength() {
		return estimatedCloudletLength;
	}

	public void setEstimatedCloudletLength(long estimatedCloudletLength) {
		this.estimatedCloudletLength = estimatedCloudletLength;
	}
	
	public boolean setCloudletLength(final long cloudletLength) {
		super.setCloudletLength(cloudletLength);
		return true;
	}
